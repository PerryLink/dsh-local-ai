...
[![dshfind](https://dshfind.com/api/badge/PerryLink/dsh-local-ai?metric=downloads&lang=hi)](https://dshfind.com/hi/plugins/PerryLink/dsh-local-ai?ref=badge)
...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-alpha.2` (2026-09-18 को सत्यापित: तीन typecheck (इंस्टॉल, CI, checkout) + 135 टेस्ट + self-contained/artifacts गेट)। peer रेंज सभी समर्थित लाइनों को स्वीकार करती है: `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0 \|\| >=0.1.7-0 <0.2.0`; dev/test पिन `0.1.7-alpha.2` हैं। |
| Node | `^22.19.0 \|\| >=24.0.0` |
