...
- **alpha.3** — desenvolvido e testado contra `@deepseek-ai/dsh@0.1.2-alpha.3`; espera-se que baselines mais novos funcionem, mas são verificados pelo workflow mensal de compat.
...
pnpm run typecheck  # tsc: src + testes contra os tipos publicados 0.1.2-alpha.3
