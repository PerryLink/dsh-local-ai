...
- **npm 0.1.5-rc.1** — desarrollado y probado contra `@deepseek-ai/dsh@0.1.5-rc.1`; se espera que baselines más nuevos funcionen, pero los verifica el workflow mensual de compat.
...
pnpm run typecheck  # tsc: src + tests contra los tipos publicados 0.1.5-rc.1
